...
public class LaserPointer : MonoBehaviour
{
    ...
    private void Teleport()
    {
        ...
        GameObject objInHand = ControllerGrabObjectRight.objectInHand; // controllerPose.GetComponent<ControllerGrabObjectRight>().objectInHand;
        ...
        {
            if (objInHand.GetComponent<FixedJoint>())
            {
    ...
    IEnumerator Example(GameObject onPlate, GameObject objInHand)
    {
        ...
        //Destroy(objInHand.GetComponent<FixedJoint>());
    }
